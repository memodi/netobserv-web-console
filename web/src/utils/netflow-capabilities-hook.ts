...
import { dnsLatencyMatcher, droppedIdMatcher, OverviewPanel, rttIdMatcher, tlsIdMatcher } from './overview-panels';
    ...
    () =>
      panels.filter(
        panel =>
          ...
          (isDNSTracking || !panel.id.includes(dnsLatencyMatcher)) &&
